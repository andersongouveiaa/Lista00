...
public class TUI {
    ...
    private void printTUI() {
        System.out.print("Entre com a coordenada x do P1: ");
        setTxtXCoord(scanner.nextDouble());
        System.out.print("Entre com a coordenada y do P1: ");
        setTxtYCoord(scanner.nextDouble());
        setP1(new Ponto2D(getTxtXCoord(), getTxtYCoord()));

        System.out.print("Entre com a coordenada x do P2: ");
        setTxtXCoord(scanner.nextDouble());
        System.out.print("Entre com a coordenada y do P2: ");
        setTxtYCoord(scanner.nextDouble());
    ...
    private void printResult() {
        ...
        System.out.println("A distância entre eles é de: " + getDistanciaEntrePontos());
    }
